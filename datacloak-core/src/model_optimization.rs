use crate::onnx_model::{OnnxModel, OnnxError};
...
impl ModelOptimizer {
    ...
    pub fn quantize(&self, model: &OnnxModel, level: QuantizationLevel) -> Result<QuantizedModel, String> {
...
mod tests {
    ...
    fn test_model_quantization() {
        ...
        let quantized = optimizer.quantize(&original, QuantizationLevel::Int8).unwrap();
